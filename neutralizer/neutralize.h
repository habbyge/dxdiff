...
/**
 ...
 We go through stringIds in both base and variant and find the unchanged string values,
 copy over their indices to the neutralized base dex. same with the rest of the dex sections.
